 ...
 */
class Fans_Validate_Cpf extends Zend_Validate_Abstract
{
     ...
     */
    public function __construct($numbersOnly = true)
    {
    ...
    public function isValid($value)
    {
        ...
        if (preg_match($this->_regexp, $value) && $this->_checkDigitOne($this->_removeNonDigits($value)) && $this->_checkDigitTwo($this->_removeNonDigits($value))) 
        {
            return true;
        }
