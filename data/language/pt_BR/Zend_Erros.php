...
return array(
    ...
    // Outros erros
    "This XML file does not appear to have any style information associated with it. The document tree is shown below." => "Este arquivo XML não tem um arquivo de estilo associado com ele. O arquivo XML encontra-se logo abaixo.",
    
    
    // Zend_Validate_Db_NoRecordExists
    "A record matching '%value%' was found" => "'%value%' já existe em nosso banco de dados",
    "No record matching '%value%' was found" => "'%value%' não existe em nosso banco de dados",    
);
